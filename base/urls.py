...
common_tool = [
    ...
    path('Common_wikipedia_summary', Common_wikipedia_summary,name='Common_wikipedia_summary'),
    path('Common_convert_docx_to_pdf', Common_convert_docx_to_pdf,name='Common_convert_docx_to_pdf'),
    path('Common_convert_pdf_to_docx', Common_convert_pdf_to_docx,name='Common_convert_pdf_to_docx'),
    path('Common_convert_pdf_to_excel', Common_convert_pdf_to_excel,name='Common_convert_pdf_to_excel'),
    path('Common_convert_excel_to_pdf', Common_convert_excel_to_pdf,name='Common_convert_excel_to_pdf'),
    path('Common_convert_jpg_to_pdf', Common_convert_jpg_to_pdf,name='Common_convert_jpg_to_pdf'),
    path('Common_convert_jpg_to_word', Common_convert_jpg_to_word,name='Common_convert_jpg_to_word'),
    path('Common_calculator', Common_calculator,name='Common_calculator'),
    path('Common_cgpa_calculator', Common_cgpa_calculator,name='Common_cgpa_calculator'),
    ...
    path('Common_Code_scriping', Common_Code_scriping,name='Common_Code_scriping'),
]
