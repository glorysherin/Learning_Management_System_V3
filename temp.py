...
'''
 if splited[0] == "Absent":
                try:
                    ...
                    c_attendee = Attendees.objects.get(roll=splited[3])
                    ...
                    attendee = Attendees.objects.get(roll=splited[3])
                ...
                subject = 'Absence Notification - {obje.get_name} from JEC'
                
                email_from = settings.EMAIL_HOST_USER
                recipient_list = ["glorysherin22@gmail.com"]
                
                class_obj = ClassRooms.objects.get(id=splited[2])
...
I hope this email finds you well. I am writing to inform you that your child, {obje.get_name}, was absent from college today.and to  provide you with an update on your child's attendance, academic progress. Reason for Absence (if known): [Provide reason for the absence if available. For example, illness, personal reasons, etc.]  .   Absence Today:
I would like to inform you that your child was absent from college today. The reason for their absence, if known, is [Provide reason for the absence if available. For example, illness, personal reasons, etc.] We understand that occasional absences may occur due to unforeseen circumstances, and we appreciate your prompt communication regarding your child's absence. If there are any extenuating circumstances or if your child requires any academic support to catch up on missed work, please let us know, and we will be happy to assist.   Attendance Percentage:
Your child, {obje.get_name}, has maintained a regular presence in the college. The attendance percentage for the current academic month is {current_month}%. Number of Working Days:
During the past month, our college had a total of {total_count} working days. I am pleased to inform you that your child attended {no_of_days} days out of these, which demonstrates their dedication towards their studies.Last Month Attendance Percentage:
In the previous month, {obje.get_name} achieved an attendance percentage of {prev_month}.Test Marks:
Regarding academic performance, I am delighted to share that {obje.get_name} performed exceptionally well in the recent tests. Their test marks demonstrate a thorough understanding of the subjects and reflect their consistent efforts and hard work.Should you have any concerns or queries regarding your child's progress or any other matter, please do not hesitate to reach out to us. We are always here to provide guidance and support.
